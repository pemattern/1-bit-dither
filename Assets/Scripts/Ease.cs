...
public static class Ease
{
    ...
    public static float ProgressNormalized(float starting, float target, float current)
    {
    ...
    public static float ProgressNormalized(Vector3 starting, Vector3 target, Vector3 current)
    {
